...
class FileRuntimeLocalizationService<T extends RuntimeLocalizationBase>
  ...
  FileRuntimeLocalizationService({
    ...
    Future<void> Function(FileRuntimeLocalizationService<T>)? onEmpty,
        ...
        _configurableDirectory = directory;

  late final Directory _baseDirectory;
  final Directory _configurableDirectory;
  ...
  Directory get baseDirectory {
    if (initializationState == 0) {
      throw UninitializedRuntimeLocalizationException();
    }
  ...
  Directory get _directory {
    var directoryPath =
        baseDirectory.uri.resolve(_configurableDirectory.uri.asPath).asPath;
  ...
  Future<void> initialize() async {
    if (initializationState == 2) return;
